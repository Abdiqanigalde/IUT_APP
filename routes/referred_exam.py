...
def download_pdf(reg_id):
    ...
    elements.append(Paragraph(
        ...
        "+880-2-996691252 &nbsp; PABX : +880-2-996691254-59 &nbsp; Fax : +880-2-996691260<br/>"
        "e-mail : registrar@iut-dhaka.edu &nbsp; website : www.iutoic-dhaka.edu",
        ParagraphStyle('REAddress', parent=styles['Normal'], fontSize=7.5,
                        alignment=TA_CENTER, textColor=colors.HexColor('#6b7280'), leading=10)
    ))
